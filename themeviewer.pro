...
UBUNTU_TRANSLATION_DOMAIN="themeviewer.liu-xiao-guo"
...
aptest.commands = bash $$PWD/themeviewer/tests/autopilot/run
aptest.depends  = sub-themeviewer

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/themeviewer/tests/unit
unittest.depends  = sub-themeviewer
